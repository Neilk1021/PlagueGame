...
namespace PluginMaster
{
    ...
    public static partial class PWBIO
    {
        ...
        private static void LineInput(bool persistent)
        {
            ...
            else if (PWBSettings.shortcuts.lineSelectAllPoints.keyCombination.Check()) lineData.SelectAll();
            else if (PWBSettings.shortcuts.lineDeselectAllPoints.keyCombination.Check())
            {
                lineData.selectedPointIdx = -1;
                lineData.ClearSelection();
            }
            else if (PWBSettings.shortcuts.lineToggleCurve.keyCombination.Check())
            {
                lineData.ToggleSegmentType();
                updateStroke = true;
            }
            else if (PWBSettings.shortcuts.lineToggleClosed.keyCombination.Check())
            {
            ...
            if (PWBSettings.shortcuts.editModeSelectParent.keyCombination.Check() && lineData != null)
            {
