...
namespace PluginMaster
{
    ...
    public static partial class PWBIO
    {
        ...
        private static void SelectionInput(System.Collections.Generic.List<Vector3> points, bool in2DMode)
        {
            ...
            if (PWBSettings.shortcuts.selectionTogglePositionHandle.keyCombination.Check())
            {
                SelectionToolManager.settings.move = !SelectionToolManager.settings.move;
                PWBToolbar.RepaintWindow();
            }
            else if (PWBSettings.shortcuts.selectionToggleRotationHandle.keyCombination.Check())
            {
                SelectionToolManager.settings.rotate = !SelectionToolManager.settings.rotate;
                PWBToolbar.RepaintWindow();
            }
            else if (PWBSettings.shortcuts.selectionToggleScaleHandle.keyCombination.Check())
            {
                SelectionToolManager.settings.scale = !SelectionToolManager.settings.scale;
                PWBToolbar.RepaintWindow();
            }
            else if (Event.current.type == EventType.KeyDown
                && (PWBSettings.shortcuts.selectionEditCustomHandle.keyCombination.Check()
            ...
            else if (PWBSettings.shortcuts.selectionRotate90XCCW.keyCombination.Check())
                RotateSelection90Deg(Vector3.left, points);
            else if (PWBSettings.shortcuts.selectionRotate90XCW.keyCombination.Check())
                RotateSelection90Deg(Vector3.right, points);
            else if (PWBSettings.shortcuts.selectionRotate90YCCW.keyCombination.Check())
                RotateSelection90Deg(Vector3.down, points);
            else if (PWBSettings.shortcuts.selectionRotate90YCW.keyCombination.Check())
                RotateSelection90Deg(Vector3.up, points);
            else if (PWBSettings.shortcuts.selectionRotate90ZCCW.keyCombination.Check())
                RotateSelection90Deg(Vector3.back, points);
            else if (PWBSettings.shortcuts.selectionRotate90ZCW.keyCombination.Check())
