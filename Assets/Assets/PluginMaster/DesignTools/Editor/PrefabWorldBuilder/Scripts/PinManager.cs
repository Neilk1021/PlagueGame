    ...
    public static partial class PWBIO
    {
        ...
        private static void PinInput(UnityEditor.SceneView sceneView)
        {
            ...
            if (Event.current.button == 0)
            {
                ...
                {
                    if (PWBSettings.shortcuts.pinMoveHandlesUp.keyCombination.Check()) _pinOffset = nextBoundLayer;
                    else if (PWBSettings.shortcuts.pinMoveHandlesDown.keyCombination.Check()) _pinOffset = prevBoundLayer;
                    else if (PWBSettings.shortcuts.pinSelectNextHandle.keyCombination.Check()) _pinOffset = nextBoundPoint;
                    else if (PWBSettings.shortcuts.pinSelectPivotHandle.keyCombination.Check()) _pinOffset = pivotBoundPoint;
                    //add rotation around Y
                    else if (PWBSettings.shortcuts.pinRotate90YCW.keyCombination.Check())
                        _pinAngle.y = (_pinAngle.y + 90) % 360;
                    else if (PWBSettings.shortcuts.pinRotate90YCCW.keyCombination.Check())
                        _pinAngle.y = (_pinAngle.y - 90) % 360;
                    else if (PWBSettings.shortcuts.pinRotateAStepYCW.keyCombination.Check())
                        _pinAngle.y -= PinManager.rotationSnapValue;
                    else if (PWBSettings.shortcuts.pinRotateAStepYCCW.keyCombination.Check())
                        _pinAngle.y += PinManager.rotationSnapValue;
                    //add rotation around X
                    else if (PWBSettings.shortcuts.pinRotate90XCW.keyCombination.Check())
                        _pinAngle.x = (_pinAngle.x + 90) % 360;
                    else if (PWBSettings.shortcuts.pinRotate90XCCW.keyCombination.Check())
                        _pinAngle.x = (_pinAngle.x - 90) % 360;
                    else if (PWBSettings.shortcuts.pinRotateAStepXCW.keyCombination.Check())
                        _pinAngle.x -= PinManager.rotationSnapValue;
                    else if (PWBSettings.shortcuts.pinRotateAStepXCCW.keyCombination.Check())
                        _pinAngle.x += PinManager.rotationSnapValue;
                    //add rotation around Z
                    else if (PWBSettings.shortcuts.pinRotate90ZCW.keyCombination.Check())
                        _pinAngle.z = (_pinAngle.z + 90) % 360;
                    else if (PWBSettings.shortcuts.pinRotate90ZCCW.keyCombination.Check())
                        _pinAngle.z = (_pinAngle.z - 90) % 360;
                    else if (PWBSettings.shortcuts.pinRotateAStepZCW.keyCombination.Check())
                        _pinAngle.z -= PinManager.rotationSnapValue;
                    else if (PWBSettings.shortcuts.pinRotateAStepZCCW.keyCombination.Check())
                        _pinAngle.z += PinManager.rotationSnapValue;
                    //reset rotation
                    else if (PWBSettings.shortcuts.pinResetRotation.keyCombination.Check())
                        _pinAngle = Vector3.zero;
                    else if (PWBSettings.shortcuts.pinSubtract1UnitFromSurfDist.keyCombination.Check())
                        _pinDistanceFromSurface -= 1f;
                    else if (PWBSettings.shortcuts.pinAdd1UnitToSurfDist.keyCombination.Check())
                        _pinDistanceFromSurface += 1f;
                    else if (PWBSettings.shortcuts.pinSubtract01UnitFromSurfDist.keyCombination.Check())
                        _pinDistanceFromSurface -= 0.1f;
                    else if (PWBSettings.shortcuts.pinAdd01UnitToSurfDist.keyCombination.Check())
                        _pinDistanceFromSurface += 0.1f;
                    else if (PWBSettings.shortcuts.pinResetSurfDist.keyCombination.Check())
                        _pinDistanceFromSurface = 0;
                    else if (PWBSettings.shortcuts.pinResetScale.keyCombination.Check()) UpdatePinScale(1f);
                    else if (PWBSettings.shortcuts.pinToggleRepeatItem.keyCombination.Check())
                    {
