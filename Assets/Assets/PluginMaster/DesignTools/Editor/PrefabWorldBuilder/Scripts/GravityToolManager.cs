...
namespace PluginMaster
{
    ...
    public static partial class PWBIO
    {
        ...
        private static void GravityToolDuringSceneGUI(UnityEditor.SceneView sceneView)
        {
            ...
            else if (PWBSettings.shortcuts.pinSubtract1UnitFromSurfDist.keyCombination.Check()) AddHeight(-1f);
            else if (PWBSettings.shortcuts.pinAdd1UnitToSurfDist.keyCombination.Check()) AddHeight(1f);
            else if (PWBSettings.shortcuts.pinSubtract01UnitFromSurfDist.keyCombination.Check()) AddHeight(-0.1f);
            else if (PWBSettings.shortcuts.pinAdd01UnitToSurfDist.keyCombination.Check()) AddHeight(0.1f);
