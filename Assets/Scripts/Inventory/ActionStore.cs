...
namespace RPG.Inventory
{
    ...
    public class ActionStore : MonoBehaviour, ISaveable
    {
        ...
        public void AddAction(Item item, int index, int number)
        {
            if (dockedItems.ContainsKey(index))
            {
        ...
        public int MaxAcceptable(Item item, int index)
        {
        ...
        object ISaveable.CaptureState()
        {
            ...
            foreach (var pair in dockedItems)
            {
                ...
                record.itemID = pair.Value.item.GetUUID();
        ...
        void ISaveable.RestoreState(object state)
        {
            ...
            {
                AddAction(GetComponent<ItemCache>().GetItem(pair.Value.itemID), pair.Key, pair.Value.number);
            }
        }
    }
}